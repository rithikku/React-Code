    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://justcreative.com/wp-content/uploads/2023/02/Restaurant-Logo-Templates-1024x682.png.webp"/>
            </div>
            <div className="nav-items">
                <ul>
                    ...
                    <li>About Us</li>
                    <li>Contact Us</li>
                    <li><img className="cart" src="https://img.icons8.com/?size=160&id=QVQY51sDgy1I&format=png"/></li>
                </ul>
            </div>
        </div>
    )
